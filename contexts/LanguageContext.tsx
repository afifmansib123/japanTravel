...
const translations = {
  en: {
    ...
    'home.hero.desc1': 'Experience the world like never before with our curated travel packages',
    'home.hero.title2': 'Adventure Awaits',
    'home.hero.desc2': 'From mountain peaks to pristine beaches, your next adventure starts here',
    'home.hero.title3': 'Cultural Immersion',
    'home.hero.desc3': 'Immerse yourself in local cultures and create memories that last a lifetime',
    ...
    'home.company.desc': 'With over 15 years of experience in creating unforgettable travel experiences, we specialize in crafting personalized tours that connect you with the heart and soul of each destination.',
    'home.cta.title': 'Ready for Your Next Adventure?',
    'home.cta.subtitle': 'Join thousands of satisfied travelers who have discovered the world with us',
  ...
  zh: {
    ...
    'home.company.desc': '凭借超过15年创造难忘旅行体验的经验，我们专门制作个性化旅游，将您与每个目的地的核心和灵魂联系起来。',
  ...
  ja: {
    ...
    'home.hero.desc1': '厳選された旅行パッケージで、これまでにない世界を体験してください',
    'home.hero.title2': '冒険があなたを待っています',
    'home.hero.desc2': '山頂から手つかずのビーチまで、あなたの次の冒険がここから始まります',
    ...
    'home.company.desc': '15年以上の忘れられない旅行体験の創造経験を持つ私たちは、あなたを各目的地の心と魂に結びつけるパーソナライズされたツアーの作成を専門としています。',
    'home.cta.title': '次の冒険の準備はできていますか？',
    'home.cta.subtitle': '私たちと一緒に世界を発見した何千人もの満足した旅行者に参加してください',
    ...
    'cart.signin.required': 'チェックアウトを続行するにはサインインしてください',
